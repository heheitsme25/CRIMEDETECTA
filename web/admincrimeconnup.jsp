<%-- 
    Document   : admincrimeconnup
    Created on : 6 Apr, 2024, 11:16:26 PM
    Author     : ashir
--%>
...
try {
    ...
    if (Districtname == null || Areaname == null || Policestation == null || Hospital == null || Crime == null) {
        ...
        String q1 = "INSERT INTO crimeup (Areano, Districtname, Areaname, Pincode, Policestation, Hospital, Hospno, Crime) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
