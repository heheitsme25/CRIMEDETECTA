<%-- 
    Document   : connectionup
    Created on : 6 Apr, 2024, 11:15:16 PM
    Author     : ashir
--%>
...
<body>
    <div class="gradient-background">
        <form action="admincrimeconnup.jsp" method="post">
    ...
    <div class="form-container">
        <h1><bold>Crime Registration for Uttar Pradesh</bold></h1>
        <form action="admincrimeconnup.jsp" method="post">
